...
-- ('Glory Box','5:09', TRUE, 'WjNGrpugizs',4,4),
...
-- INSERT INTO playlistSongs (song_id, artist_id, album_id, playlist_id) VALUES 
-- (1,1,1,1),
-- (2,2,2,1),
-- (3,3,3,1),
-- (4,4,4,1),
...
('One Beer','MF Doom', 'MM..FOOD', '4:19', FALSE),
('Deep Fried Frenz', 'MF Doom', 'MM..FOOD',  '5:00', FALSE),
('Kon Queso','MF Doom', 'MM..FOOD',  '4:00', FALSE),
('Roads', 'Portishead', 'Dummy', '5:04', FALSE);